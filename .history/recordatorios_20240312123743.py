# DESAFIO CON MANEJO DE LISTAS - METODOS APPEND, ENUMERATE, SORT
...
# Output
print("*************************************************")
print(f"Ya no tenemos el dia: \033[1m{fecha_a_eliminar}\033[0m, sorry y hemos agregado \033[1m{cena_navi}\033[0m y \033[1m{cena_ano}\033[0m")
