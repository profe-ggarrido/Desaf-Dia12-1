...
print(f"\033[41mEn soles pé:\033[0m {resultado_sol}")
print(f"\033[41mPa los CHÉ argentinos:\033[0m {resultado_peso}")
print(f"\033[41mY en dólares gringos:\033[0m {resultado_dolar}")
